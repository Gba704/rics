...
<body class="container-fluid">
  ...
  <h2>Relatorio de Venda de Areas</h2>
  ...
  <div class="col-md-2">
    <label>Areas de cursos</label>
    <select class="form-select">
      <option>Tecnoligia</option>
  ...
  <div class="table-responsive mt-4">
    <table class="table table-bordered" id="tabela">
      ...
      <tbody>
        ...
        <td>
          <a href="a" class="text-danger" onclick="return confirm('Tem certeza que quer Excluir')">
